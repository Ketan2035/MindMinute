...
const Profile = () => {
  ...
  // Heatmap calculation (last 16 weeks / 112 days)
  const today = new Date();
  today.setHours(0,0,0,0);
  const startDate = new Date(today);
  startDate.setDate(today.getDate() - 111); // 112 days total
  ...
  for (let i = 0; i < 112; i++) {
    ...
    calendarDays.push({ date: dateString, count, bgClass });
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-indigo-100 rounded-full flex items-center justify-center text-4xl font-bold text-indigo-700 shadow-sm border-2 border-white ring-2 ring-gray-100 mb-4">
              ...
              <button 
                ...
                className="flex items-center justify-center w-full px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-semibold rounded-lg transition-colors"
              >
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
                <h3 className="text-sm font-bold text-gray-900 mb-4 flex items-center">
                ...
                <div className="grid grid-flow-col grid-rows-7 gap-1.5 overflow-x-auto pb-2">
                  {calendarDays.map((day, i) => (
                    <div 
                      key={day.date} 
                      title={`${day.date}: ${day.count} speeches`}
                      className={`w-4 h-4 rounded-sm ${day.bgClass} hover:ring-2 hover:ring-gray-300 transition-all cursor-crosshair`}
                    />
                  ))}
                </div>
                <div className="flex items-center justify-between mt-4 text-[10px] font-semibold text-gray-500 uppercase tracking-wider">
                  <span>Less</span>
